...
if (is_login() == false) {
    ...
    $proveri_servere = mysql_num_rows(mysql_query("SELECT * FROM `serveri` WHERE `user_id` = '$_SESSION[userid]' AND `igra` != '6' AND `igra` != '7'"));
    if (!$proveri_servere) {
                        ...
                        <div id="serveri">
                            <center><table class="darkTable">
                                <tbody>
                                    ...
                                    <?php  
                                        $gp_obv = mysql_query("SELECT * FROM `serveri` WHERE `user_id` = '$_SESSION[userid]' AND `igra` != '6' AND `igra` != '7'");
