            ...
            <div id="server_info_infor">
                <div id="server_info_infor2">
                    ...
                    <div class="gp-home">
                        ...
                        <h2 style="margin-left: 60px;color: #ba0000;font-size: 30px;">Billing</h2>
                        <h3 style="font-size: 12px;margin-left: 60px;margin-top: -5px;">Lista svih vasih narudzba</h3>
                        ...
                        <div id="tiket_body">   
                            <div class="tiket_info">
                                ...
                                <div class="gleda" style="width: 97%; height: 25px; padding: 11px 0px 0px 10px; background: rgba(0,0,0,0.5);border: 1px solid #333;color: #bbb;margin: 0px 9px;">   
                              ...
                              margin: 7px 9px; margin-bottom: 20px;">
                                        <div class="tiket_info_home">
                                            <div class="tiket_info_home_a">
                                                <li style="list-style-type: none;"><img src="<?php echo user_avatar($_SESSION['userid']); ?>" alt=""></li>
                                                <li style="list-style-type: none;"><p><strong><?php echo ime_prezime($_SESSION['userid']); ?></strong></p></li>
                                            </div>
                                            ...
                                            <?php if ($pay_status == "0") { ?>
                                                ...
                                                <div class="bill_pay_">
                                                    ...
                                                    <li style="list-style-type: none;">
                                                        <a href="https://keepme.live/x/u/gb-hoster">
                                                            <img src="./img/icon/pp_i.png" style="width:15px;height:20px;"> PayPal
                                                        </a>
                                                    </li>
                                                    <li style="list-style-type: none;"><a href="/banka.php"><span class="fa fa-bank"></span> Banka/Posta</a></li>                                                                                                
                                                <li><a href="https://keepme.live/x/u/gb-hoster"><span class="fa fa-commenting-o"></span> SMS</a></li>
                                                </div>
                                            <?php } elseif ($pay_status == "1") { ?>
                                                ...
                                                <div class="bill_pay_">
                                                    ...
                                                    <label for="billing_pay">UPLATI PREKO : </label>
                                                    <li><a href="https://keepme.live/u/adam93">
                                                            <img src="./img/icon/pp_i.png" style="width:15px;height:20px;"> PayPal
                                                        </a></li>
                                                    ...
                                                    <li><a href="https://www.e-game.me/sms/"><span class="fa fa-commenting-o"></span> SMS</a></li>
                                                </div>
